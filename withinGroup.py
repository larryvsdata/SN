...
def generateHybridInGroup(G,nodeList,kAverage,pSelection,pConnection,groupPercent,interval):            
...
#           print "random"
        ...
        if index>groupStartIndex and index%interval==0:
            percentage=0.07
            hubs=getHubs(G,percentage)
            print hubs
            for hub in hubs:
                print "Hub ",hub
...
#Create the graph
generateHybridInGroup(G_hybrid,nodeList,kAverage,pSelection,pConnection,groupPercent,interval)
